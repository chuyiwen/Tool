...
public:
	...
	bool LoadFile(IFS* pFS, LPCTSTR szFilename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	...
	bool LoadFile(IFS* pFS, tstring& strFilename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
		return LoadFile(pFS, strFilename.c_str(), encoding );
	}
